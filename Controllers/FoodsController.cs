...
namespace Cook_Book.Controllers
{
    public class FoodsController : Controller
    {
        ...
        public FoodsController(CookBookDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Detail")] Food food)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Detail")] Food food)
        {
            if (id != food.Id)
            {
                return NotFound();
        ...
        public async Task< ActionResult> Search(string search)
        {
            ...
            List<Food> foods = await _context.Foods.Where(x => x.Name.Contains(search)).ToListAsync();
